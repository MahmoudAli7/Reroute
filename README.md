...
Purpose of the app is to provide a route that will avoid buffers with real-time routing capabilities for multi-purpose utility such as fleets carrying hazardous materials and emergency responses. Tech stack used for the project include React, TailwindCSS, ESRI REST API, Leaflet.
